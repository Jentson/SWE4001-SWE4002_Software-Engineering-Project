...
$query = "INSERT INTO staff (staff_id, staff_name, staff_email, staff_pass, roles) VALUES (?,?,?,?,?)";
$stmt = $conn->prepare($query);
$stmt->bind_param("issss", $staff_id, $staff_name, $staff_email, $hashed_password, $roles);
...
<body>
    ...
    <p>
        ...
        <select name="roles" required>
            ...
            <option value="HOP">Head Of Department</option>
