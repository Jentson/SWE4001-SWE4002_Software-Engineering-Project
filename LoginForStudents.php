...
<link href="styles/studlogin.css" rel="stylesheet">
...
<script>
    function validateForm() {
      ...
      var password = document.forms["StudentLogin"]["Spass"].value;
      var errors = [];
    ...
    if (password == ""){
        ...
        if (/[!@#$%^&*(),.?":{}|<>]/.test(password)){
            errors.push("Special Charactercs are not allowed");
        }
    }
		...
		<div class="row justify-content-center mt-5">
		  <div class="col-lg-4 col-md-6 col-sm-6">
			<div class="card shadow">
			  ...
			  <div class="card-body">
				<form name ="StudentLogin" onsubmit="return validateForm()" method="POST" action ="<?php echo $_SERVER['PHP_SELF'];?>" class="needs-validation">
