...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2024 at 11:30 AM
...
CREATE TABLE `approval` (
  ...
  `lecturer_process` int(11) NOT NULL,
  `ioav_process` int(11) NOT NULL,
  `hop_process` int(11) NOT NULL
...
INSERT INTO `enrollment` (`enrollment_id`, `stud_id`, `subj_code`) VALUES
(1, 'J22036755', 'ICT30010'),
(2, 'J22036755', 'SWE20001'),
(3, 'J22036756', 'COS10009'),
(4, 'J22036756', 'COS30019');
...
(123460, 'RodLecturer', 'rod@newinti.edu.my', '$2y$10$q7PhzE6UxZJrIyaQ.SwgPeryQEnvJL21ygXNu5daMRDFy79w3GROW', 'Lecturer'),
(123462, 'RodHOP', 'rod@newinti.edu.my', '$2y$10$eKrSNrHaW1CWVY9bVBVSxuxZhqLxt1AfTXsprb/iFlN16OxmJMQY.', 'HOP'),
(123463, 'RodIOAV', 'rod@newinti.edu.my', '$2y$10$Cuj18PBkSGCwIVMY2VOEPum/rCam6Iqa1CP3IeelPzkcIUiUQEUXG', 'IOAV');
...
ALTER TABLE `enrollment`
  ...
  ADD KEY `subject_code` (`subj_code`);
...
ALTER TABLE `leave_application`
  ADD PRIMARY KEY (`id`),
  ADD KEY `leave_application_ibfk_1` (`stud_id`);
...
ALTER TABLE `students`
  ...
  ADD KEY `students_ibfk_1` (`dept_ID`);
...
--
ALTER TABLE `enrollment`
  ADD CONSTRAINT `enrollment_ibfk_1` FOREIGN KEY (`stud_id`) REFERENCES `students` (`stud_id`),
  ADD CONSTRAINT `enrollment_ibfk_2` FOREIGN KEY (`subj_code`) REFERENCES `subject` (`subj_code`);
