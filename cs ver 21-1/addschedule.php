...
// header("index.php");
// }
$usersession = $_SESSION['staffSession']; // Updated variable name

$res = mysqli_query($con, "SELECT * FROM staff WHERE staffId=" . $usersession); // Updated table name
...
<html lang="en">
    <head>
        ...
        <title>Welcome Dr <?php echo $userRow['staff_id'];?> <?php echo $userRow['staff_name'];?></title>
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="doctordashboard.php">Welcome Dr <?php echo $userRow['staff_id'];?> <?php echo $userRow['staff_name'];?></a>
                </div>
                <!-- Top Menu Items -->
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $userRow['staff_id']; ?> <?php echo $userRow['staff_name']; ?><b class="caret"></b></a>
                ...
                <div class="container-fluid">
                                 ...
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="endtime" name="endtime" type="text" required readonly/>
                                   </div>
                                  </div>
                                 </div>
                                 <div class="form-group form-group-lg">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($stafftimeschedule=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$stafftimeschedule['timeID']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function generateTimeSlots() {
            ...
            var duration = 20; // in minutes

            // Convert start time to minutes
            var startTimeMinutes = parseInt(startTime.split(':')[0]) * 60 + parseInt(startTime.split(':')[1]);

            // Calculate end time based on start time and duration
            var endTimeMinutes = startTimeMinutes + duration;

            // Format and set the end time
            $('#endtime').val(formatTime(endTimeMinutes));
