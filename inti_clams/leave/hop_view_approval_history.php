...
WHERE hop_approval.hop_id = ? AND hop_approval.process = 1";
...
if ($start_date && $end_date && $end_date < $start_date) {
    ...
    echo '<script>window.location.href = "hop_view_approval_history.php";</script>';
    exit();
}
...
if (isset($_POST['export_selected_csv'])) {
    if (isset($_POST['selected_rows']) && !empty($_POST['selected_rows'])) {
        ...
        $headers = ['ID', 'Student ID', 'Student Name', 'Subject Code', 'Start Date', 'End Date', 'File/Evidence', 'Reason', 'Lecturer Status', 'IOAV Status', 'HOP Status'];
...
<?php include '../index/staff_navbar.php'; ?>
        <!-- Page content-->
                ...
                <h4 class="mb-3 text-center">HOP Approval History</h4><hr>
                <div class="row mb-3">
                <div class="col-md-8">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center table-sm">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="12">No leave applications found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
