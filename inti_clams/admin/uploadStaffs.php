...
<body class="bg-light">
     ...
     <div class="row justify-content-center">
            <div class="col-12">
                <img src="../images/logo-inti-subang.png" class="rounded mx-auto d-block" alt="INTI logo"><br>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end mb-2">
            ...
            <div class="card">
                <div class="card-header text-center">
                    <h2>Upload CSV File For Staff</h2>
                </div>
                <div class="card-body">
                    <form action="uploadStaff.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                        <div class="mb-3">
