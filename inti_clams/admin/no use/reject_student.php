...
if (isset($_GET['id'])) {
    ...
    // Update the status of the student account to 'Rejected' in the database
    $query = "UPDATE student SET status_id = '3' WHERE student_id = ?";
    $stmt = $con->prepare($query);
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            // Recipients
            $mail->setFrom('your-email@gmail.com', 'Your Name or Service');
            ...
            $mail->Body .= '<p>We regret to inform you that your account application has not been approved.</p>';
            $mail->Body .= '<p>If you have any questions or require further assistance, please do not hesitate to contact us.</p>';
        ...
        echo "Error rejecting the student account: " . $stmt->error;
    }
